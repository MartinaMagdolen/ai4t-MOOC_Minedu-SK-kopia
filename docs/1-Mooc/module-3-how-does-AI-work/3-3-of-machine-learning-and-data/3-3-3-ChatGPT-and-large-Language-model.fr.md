...
Všetky videá, ktoré vytvoril tím Inria - Flowers, si môžete pozrieť a stiahnuť z webovej stránky [ChatGPT za 5 minút](http://developmentalsystems.org/chatgpt_en_5_minutes/){:target="_blank"}.

## 2 - Možnosti využitia vo vzdelávaní
Dve doplňujúce sa publikácie francúzskeho ministerstva školstva a Pôle d'Expertise de la Régulation Numérique (Odborné centrum pre digitálnu reguláciu) poskytujú ďalší pohľad na možné využitie jazykových modelov (1) a technológií umelej inteligencie (2), ktoré sú ich základom, vo vzdelávaní.
