---
názov: "4.1.2 Rozhodovanie s pomocou AI"
popis: "Ako nástroje na podporu rozhodovania menia postupy, ako ich môžu zlepšiť a prečo je potrebné kriticky ich analyzovať."
---
??? info "Metadáta
    - Id: EU.AI4T.O1.M4.1.2t
    - Názov: 4.1.2 Rozhodovanie s pomocou AI
    - Typ: text
    - Opis: Ako nástroje na podporu rozhodovania menia postupy, ako ich môžu zlepšiť a prečo je potrebné kriticky ich analyzovať.
...
- **Automatizácia rozhodovania:** Systém robí rozhodnutia sám pomocou preskriptívnej alebo prediktívnej analýzy. Medzi výhody tohto prístupu patrí rýchlosť, škálovateľnosť a konzistentnosť rozhodovania.

- **Rozšírenie rozhodovania:** Systém odporučí rozhodnutie alebo viacero alternatív pre ľudských aktérov, a to opäť pomocou preskriptívnej alebo prediktívnej analýzy. Medzi výhody tohto prístupu patrí synergia medzi ľudskými poznatkami a schopnosťou umelej inteligencie rýchlo analyzovať veľké objemy dát a zvládať zložitosť.
...
[^1]: [Would You Let Artificial Intelligence Make Your Pay Decisions?](https://www.gartner.com/smarterwithgartner/would-you-let-artificial-intelligence-make-your-pay-decisions) - Starita, L. Článok na [https://www.gartner.com/](https://www.gartner.com/) (prístup 06/10/2022).
