...
popis: "Pôvod troch využití umelej inteligencie: prirodzené rozhrania, rozpoznávanie obrazu a autonómne auto."
prispievateľ: 
...
??? info "Metadáta
    ...
    - Názov: 2.2.4 Aktivita: Pôvod AI technológií
    - Typ: aktivita
    - Opis: Pôvod troch využití umelej inteligencie: prirodzené rozhrania, rozpoznávanie obrazu a autonómne auto.
...
Prirodzené rozhrania, rozpoznávanie obrazu a autonómne vozidlá sú tri technológie, ktoré sa bežne uvádzajú ako príklady využitia AI:
...
V nasledujúcej aktivite prepojíte určité vedecké pokroky s AI technológiami, ktoré by sa dali využívať vo vzdelávaní (prirodzené používateľské rozhrania a rozpoznávanie obrazu). Autonómne vozidlá budú prezentované ako príklad toho, čo ešte od umelej inteligencie očakáva.

**Chcete sa tejto trojici AI technológií dozvedieť viac?**
...
<a href="2-2-4-Activity-Discover-AI-innovations-FR/2-2-4-Origin-of-AI-innovations-FR.html" target="_blank"><figure>
  <img src="Images/AI-historical-timeline-FR.png" alt="Obrázok dejín AI" />
</figure></a>
