...
Aplikácie a technológie umelej inteligencie sú dnes neoddeliteľnou súčasťou nášho každodenného života. Dostávajú sa aj do vzdelávania, napríklad prostredníctvom automatického prekladania textov či dialógu so vzdelávacími četbotmi. Cieľom tohto portálu je pomôcť celej vzdelávacej komunite aj ostatným získať všeobecné poznatky o umelej inteligencii a podporovať vo vzdelávaní informované využívanie AI nástrojov.

Každý zdroj je k dispozícii bezplatne, viacjazyčne a s otvoreným zdrojovým kódom, vďaka čomu sa dá slobodne opätovne použiť a obsahovo adaptovať do akéhokoľvek jazyka.

Zdroje sú rozdelené do troch častí:

- 🎓 **MOOC**  
Online vzdelávací kurz pre učiteľov, ktorého obsah a aktivity sa zameriavajú na nasledujúce oblasti: súčasné aj potenciálne využitie AI vo vzdelávaní; pochopenie toho, čo to vlastne AI je a odkiaľ pochádza; experimentovanie s rôznymi technikami umelej inteligencie; identifikovanie kľúčovej úlohy dát pre AI vzdelávacie nástroje; uplatňovanie metodiky na analýzu AI vzdelávacích nástrojov.  
